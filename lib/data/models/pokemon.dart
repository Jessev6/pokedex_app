...
class Pokemon {
    ...
    factory Pokemon.fromJson(Map<String, dynamic> json) => Pokemon(
        ...
        forms: json["forms"] == null ? null : List<Species>.from(json["forms"].map((x) => Species.fromJson(x))),
...
class Move {
    ...
    factory Move.fromJson(Map<String, dynamic> json) => Move(
        ...
        versionGroupDetails: json["version_group_details"] == null ? null : List<VersionGroupDetail>.from(json["version_group_details"].map((x) => VersionGroupDetail.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "move": move == null ? null : move.toJson(),
        "version_group_details": versionGroupDetails == null ? null : List<dynamic>.from(versionGroupDetails.map((x) => x.toJson())),
    };
}
...
class VersionGroupDetail {
    ...
    Map<String, dynamic> toJson() => {
        ...
        "move_learn_method": moveLearnMethod == null ? null : moveLearnMethod.toJson(),
...
class GenerationIv {
    ...
    Map<String, dynamic> toJson() => {
        ...
        "heartgold-soulsilver": heartgoldSoulsilver == null ? null : heartgoldSoulsilver.toJson(),
...
class Versions {
    ...
    factory Versions.fromJson(Map<String, dynamic> json) => Versions(
        ...
        generationVi: json["generation-vi"] == null ? null : Map.from(json["generation-vi"]).map((k, v) => MapEntry<String, GenerationVi>(k, GenerationVi.fromJson(v))),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "generation-vi": generationVi == null ? null : Map.from(generationVi).map((k, v) => MapEntry<String, dynamic>(k, v.toJson())),
        "generation-vii": generationVii == null ? null : generationVii.toJson(),
        "generation-viii": generationViii == null ? null : generationViii.toJson(),
    };
}
...
class GenerationIii {
    ...
    factory GenerationIii.fromJson(Map<String, dynamic> json) => GenerationIii(
        emerald: json["emerald"] == null ? null : Emerald.fromJson(json["emerald"]),
        fireredLeafgreen: json["firered-leafgreen"] == null ? null : Crystal.fromJson(json["firered-leafgreen"]),
        rubySapphire: json["ruby-sapphire"] == null ? null : Crystal.fromJson(json["ruby-sapphire"]),
    );

    Map<String, dynamic> toJson() => {
        "emerald": emerald == null ? null : emerald.toJson(),
        "firered-leafgreen": fireredLeafgreen == null ? null : fireredLeafgreen.toJson(),
...
class GenerationVii {
    ...
    Map<String, dynamic> toJson() => {
        ...
        "ultra-sun-ultra-moon": ultraSunUltraMoon == null ? null : ultraSunUltraMoon.toJson(),
    };
}
...
class Other {
    ...
    Map<String, dynamic> toJson() => {
        ...
        "official-artwork": officialArtwork == null ? null : officialArtwork.toJson(),
    };
}
